...
with resident-vs-other correctness, exact-class correctness, false positives, false negatives,
and average prediction time.  For any exact-class mismatch, it also prints the detection URI.
...
- **Exact** – model predicted the same class label as the detection row.
